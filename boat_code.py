...
pwm2 = pwmio.PWMOut(board.A3, frequency=50) #left
pwm1 = pwmio.PWMOut(board.A2, frequency=50) #right
...
advertisement.complete_name = "Boat"
...
while True:
    ...
    # advertising again and waiting for a connection.# Write your code here :-)
